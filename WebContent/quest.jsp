...
int l=1;
ResultSet rs=st2.executeQuery("select userid from public.registration");
while(rs.next()){
	if(rs.getString("userid").equals(s)){
		ResultSet rs2=st1.executeQuery("select question from public.registration where userid='"+s+"'");
		rs2.next();
%>

...
st.executeUpdate("create table documentload(docname varchar(50), description text,docid integer  not null,version integer,author varchar(10),size integer,createdon date, status varchar(10),filepath varchar(200),primary key(docid),foreign key(author) references registration(userid))");
